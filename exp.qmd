...
![](images/clipboard-1688063020.png){width="889"}

Arjun has completed a Masters degree, majoring in Data Science and Analytics, at Singapore Management University, graduating with a Magna Cum Laude. The MITB Program is ranked 24th in the world for Analytics masters.
...
Arjun was the Regional SOP Demand and Performance Analyst intern completing a 7 month internship at Danone, a global leader in Dairy and Plant Based Products, parent company of brands such as Evian, Activia, Oikos, Nutricia, Volvic, Aptamil, and more.

During this Internship he was primarily responsible for developing Business Intelligence tools in order to better visualize the vast amount of data being used by the supply chain team. To optimize this process, he developed several metrics in order to automate the processes and make month-to-month and year-to-year transitions seamless.
