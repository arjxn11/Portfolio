...
In the above forecast graph, you can also see the 5th and 95th percentile (as shaded) and the sharpe ratio is also a metric calculated by the model and produced for user to see.
